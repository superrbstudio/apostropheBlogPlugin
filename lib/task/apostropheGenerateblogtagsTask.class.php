...
class generateBlogTagsTask extends sfBaseTask
{
    ...
    if (!empty($options['models']))
    {
      ...
      foreach($modelClasses as $class)
      {
        try
        {
          ...
          if (($class == 'aBlogItem') || ($class == 'aEvent'))
          {
            foreach($models as $model)
            {
              ...
              $model->save();
              $model->updatePageTagsAndCategories();
            }
          }
          else
          {
            foreach($models as $model)
            {
              ...
              $modelTags = array_values($model_tags);
