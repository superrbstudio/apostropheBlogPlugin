...
class Base<?php echo ucfirst($this->getModuleName()) ?>GeneratorHelper extends sfModelGeneratorHelper
{
  ...
  {
    return '<li class="a-admin-action-save">'.jq_link_to_function('<span class="icon"></span>'.__($params['label'], array(), 'a_admin'), "$('#a-admin-form').submit()", array('class'=>'a-btn a-save') ).'</li>';
  }
  ...
  public function linkToSaveAndAdd($object, $params)
  {
    ...
    return '<li class="a-admin-action-save-and-add">'.jq_link_to_function('<span class="icon"></span>'.__($params['label'], array(), 'a_admin'), '$(this).after("<input type=\"hidden\" name=\"_save_and_add\" value=\"1\" id=\"a_admin_save_and_add\">");$("#a-admin-form").submit()', array('class'=>'a-btn') ).'</li>';
  }
