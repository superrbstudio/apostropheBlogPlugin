  ...
  <th class="a-admin-enum a-admin-list-th-status">
    <ul class="topnav">
      <li><a href="#" class="a-blog-sort-label"><?php echo __('Status', array(), 'messages') ?></a>
        <ul class="subnav"><?php include_partial('aBlogAdmin/list_th_select', array('filters' => $filters, 'name' => 'status')) ?></ul>
      </li>
    </ul>
  </th>
  ...
  <th class="a-admin-boolean a-admin-list-th-public">
    <ul class="topnav">
      <li><a href="#" class="a-blog-sort-label"><?php echo __('Public', array(), 'messages') ?></a>
        <ul class="subnav"><?php include_partial('aBlogAdmin/list_th_select', array('filters' => $filters, 'name' => 'public')) ?></ul>
      </li>
    </ul>
  </th>
