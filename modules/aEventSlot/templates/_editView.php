...
<?php a_js_call('aBlog.slotEditView(?)', array('formName' => $form->getName(), 'autocompleteUrl' => url_for("aEventAdmin/search"), 'class' => 'events', 'selfLabelSelector' => '#'.$w->renderId().'-title',  'debug' => true)) ?>