<div class="a-blog-categories">
  ...
  <?php foreach ($categories as $category): ?>
    <li class="a-blog-filter-option"><?php echo link_to($category, aUrl::addParams(($sf_params->get('cat') == $category->getSlug()) ? 'aCalendar/index' : 'aCalendar/index?cat='.$category->getSlug(), $params['cat']), array(
...
<div class="a-blog-filter">
  <h4>Browse by</h4>
  <ul class="a-blog-filter-options">
    <li class="a-blog-filter-option"><?php echo link_to('Day', 'aCalendar/index?'.http_build_query(($dateRange == 'day') ? $params['nodate'] : $params['day']), array('class' => ($dateRange == 'day') ? 'selected' : '')) ?></li>
    <li class="a-blog-filter-option"><?php echo link_to('Month', 'aCalendar/index?'.http_build_query(($dateRange == 'month') ? $params['nodate'] : $params['month']), array('class' => ($dateRange == 'month') ? 'selected' : '')) ?></li>
    <li class="a-blog-filter-option"><?php echo link_to('Year', 'aCalendar/index?'.http_build_query(($dateRange == 'year') ? $params['nodate'] : $params['year']), array('class' => ($dateRange == 'year') ? 'selected' : '')) ?></li>
  </ul>
</div>
