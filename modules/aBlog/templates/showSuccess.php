...
<?php slot('a-subnav') ?>
	<div class="a-subnav-wrapper blog a-ui clearfix">
	    ...
	    <?php include_component('aBlog', 'sidebar', array('params' => $params, 'dateRange' => $dateRange, 'info' => $info, 'reset' => true, 'noFeed' => true, 'url' => 'aBlog/index', 'searchLabel' => a_('Search Posts'))) ?>
	  </div> 
	</div>
<?php end_slot() ?>
