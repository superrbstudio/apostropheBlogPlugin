...
<div class="author section a-form-row">
  ...
  <?php endif ?>
	...
	<?php include_partial('aEventAdmin/formAfter', array('a_event' => $a_event, 'form' => $form)) ?>
	...
	<div class="delete preview section a-form-row">
	  ...
	  <?php if($a_event->userHasPrivilege('delete')): ?>
		  <?php echo link_to('<span class="icon"></span>'.a_('Delete Event'), 'a_event_admin_delete', $a_event, array('class' => 'a-btn icon a-delete alt lite a-align-right', 'method' => 'delete', 'confirm' => a_('Are you sure you want to delete this event?'), )) ?>
	  <?php endif ?>
	</div>
