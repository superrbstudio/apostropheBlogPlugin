<div id="a-admin-bar" <?php if (count($sf_user->getAttribute('aEventAdmin.filters', null, 'admin_module'))): ?>class="has-filters"<?php endif ?>>
  <!-- <h2 class="a-admin-title you-are-here"><?php echo __('Event Post Admin', array(), 'messages') ?></h2> -->
</div>
