...
<div class="a-subnav-section categories">
  ...
  <?php foreach ($categories as $category): ?>
    <div class="a-filter-option"><?php echo link_to($category, aUrl::addParams(($sf_params->get('cat') == $category->getName()) ? 'aEvent/index' : 'aEvent/index?cat='.urlencode($category->getName()), $params['cat']), array(
...
<div class="a-subnav-section tags">  
	...
	<div class="a-blog-selected-tag">
		<div class="selected"><?php echo link_to($tag, aUrl::addParams('aEvent/index', $params['tag']), array('class' => 'selected', )) ?></div>
  </div>
	<?php endif ?>
