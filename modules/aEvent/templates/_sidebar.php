<div class="a-subnav-section categories">
  ...
  <?php foreach ($categories as $category): ?>
    <li class="a-filter-option"><?php echo link_to($category, aUrl::addParams(($sf_params->get('cat') == $category->getName()) ? 'aEvent/index' : 'aEvent/index?cat='.$category->getName(), $params['cat']), array(
