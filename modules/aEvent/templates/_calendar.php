...
<table class="a-calendar">
	...
	<tr class="month">
		<th colspan="7">
			<?php echo a_button(a_('Previous'), url_for('aEvent/index?'.http_build_query($calendar['params']['prev'])), array('a-arrow-btn', 'icon', 'a-arrow-left', 'previous-month', 'alt')) ?>
			<h4 class="title">
			...
			<?php echo a_button(a_('Next'), url_for('aEvent/index?'.http_build_query($calendar['params']['next'])), array('a-arrow-btn','icon','a-arrow-right','next-month','alt')) ?>
		</th>
	</tr>
	<tr class="days">
	...
	<tfoot>
		<tr>
			<td colspan="7">
				<a href="<?php echo url_for('aEvent/index?'. http_build_query(array('year' => date('Y'), 'month' => date('m'), 'day' => date('d')))) ?>" class="icon a-events day-<?php echo date('d') ?> alt a-calendar-today"><span class="icon"></span>Today</a>
			</td>
		</tr>
	</tfoot>
</table>
