<table class="a-calendar">
	...
	<tfoot>
		<tr>
			<td colspan="7">
				<a href="<?php echo url_for('aEvent/index?'. http_build_query(array('year' => date('Y'), 'month' => date('m'), 'day' => date('d')))) ?>" class="a-btn icon a-events day-<?php echo date('d') ?> mini nobg a-calendar-today"><span class="day"></span>Today</a>
			</td>
		</tr>
	</tfoot>
</table>
