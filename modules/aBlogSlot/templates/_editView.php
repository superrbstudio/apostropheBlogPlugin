...
<?php a_js_call('aBlog.slotEditView(?)', array('formName' => $form->getName(), 'autocompleteUrl' => url_for("aBlogAdmin/search"), 'class' => 'blog-posts', 'selfLabelSelector' => '#'.$w->renderId().'-title', 'debug' => true)) ?>